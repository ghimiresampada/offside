...
\section{Objectives}
\begin{itemize}
    \item To reconstruct real-time 3D arm and hand trajectories from three RGB webcams and map them onto a simulated robotic arm to export structured motion datasets.
\end{itemize}
