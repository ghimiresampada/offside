...
\renewcommand{\arraystretch}{1.4} % Gives vertical breathing room between rows
\setlength{\tabcolsep}{6pt}       % Forces a strict horizontal gap between all columns
\small

% Allocating dynamic wrapping (X) explicitly to both Depth Method and Primary Goal columns
\begin{tabularx}{\textwidth}{l c l X l X}
\toprule
\textbf{Work} & \textbf{Year} & \textbf{Camera Setup} & \textbf{Depth Method} & \textbf{Simulation} & \textbf{Primary Goal} \\
\midrule
Liang et al.       & 2024 & Monocular     & Transformer        & PyBullet   & DRL Training \\ \addlinespace[3pt]
Jiang et al.       & 2025 & Single RGB-D  & Hardware           & Real Robot & Robot Control \\ \addlinespace[3pt]
Faria et al.       & 2025 & Single RGB-D  & Hardware           & Real Robot & Teleoperation \\ \addlinespace[3pt]
Sarkar et al.      & 2022 & Multi RGB     & Homogeneous        & None       & HRC Safety \\ \addlinespace[3pt]
Bragagnolo et al.  & 2024 & Multi RGB     & Multi-view Fusion  & None       & Pose Accuracy \\ \addlinespace[3pt]
Bultmann \& Behnke & 2021 & Multi (edge)  & Triangulation      & None       & Real-time 3D \\ \addlinespace[3pt]
Moya-Alcover et al.& 2023 & IMU-based     & Inertial           & None       & Dataset \\ \addlinespace[3pt]
Zell et al.        & 2024 & Virtual Multi & Triangulation      & None       & Dataset \\ 
\midrule
\textbf{MotionBridge} & \textbf{2026} & \textbf{Multi RGB} & \textbf{Conf.-Weighted Tri.} & \textbf{ PyBullet} & \textbf{Simulation + Dataset} \\
\bottomrule
\end{tabularx}
\end{table}
